...
public partial class AdWDbContext : DbContext, IAdWDbContext {
    ...
    //b/c this is a partial class, I can implement the interface here w/o doing it in the main file.
    public void AddOrInsert(object entity) => Entry(entity).State = EntityState.Added;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<ProductVendor>(entity => {
            entity.HasKey(e => e.ProductId).HasName("PK_dbo.ProductVendors");

            entity.Property(e => e.ProductId).HasColumnName("ProductID");
            entity.Property(e => e.LastReceiptDate).HasColumnType("datetime");
        });

        modelBuilder.Entity<ProductVendor1>(entity => {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.ProductVendor1s)
                .HasForeignKey(d => d.BusinessEntityId)
                .OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Product).WithMany(p => p.ProductVendor1s)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.UnitMeasureCodeNavigation).WithMany(p => p.ProductVendor1s)
                .HasForeignKey(d => d.UnitMeasureCode)
                .OnDelete(DeleteBehavior.ClientSetNull);
        });
