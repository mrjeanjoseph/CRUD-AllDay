...
namespace WebTimeSheetManagement.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Dashboard()
        {
            try
            {
                var timesheetResult = _ITimeSheet.GetTimeSheetsCountByAdminID(HttpContext.Session.GetString("AdminUser"));
                ...
                var expenseResult = _IExpense.GetExpenseAuditCountByAdminID(HttpContext.Session.GetString("AdminUser"));
