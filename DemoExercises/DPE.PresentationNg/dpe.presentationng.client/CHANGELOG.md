...
- Create Angular project with ng: `ng new dpe.presentationng.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dpe.presentationng.client.esproj`).
