...
public sealed class ApproveExpenseReportValidator : AbstractValidator<ApproveExpenseReportCommand>
{
    public ApproveExpenseReportValidator(IExpenseReportRepository repo, IUserContext context)
    {
        ...
        RuleFor(x => x.ExpenseReportId)
            ...
            .WithMessage("Expense report must be submitted to approve");
    }
}
