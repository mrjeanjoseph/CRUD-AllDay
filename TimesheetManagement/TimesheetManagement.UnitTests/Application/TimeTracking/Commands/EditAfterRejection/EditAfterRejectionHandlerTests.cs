...
using TimesheetManagement.Application.TimeTracking.Commands.EditAfterRejection;
...
namespace TimesheetManagement.UnitTests.Application.TimeTracking.Commands.EditAfterRejection;

public class EditAfterRejectionHandlerTests
{
    private readonly Mock<ITimeSheetRepository> _repoMock;
    private readonly Mock<IUnitOfWork> _uowMock;
    private readonly EditAfterRejectionHandler _handler;

    public EditAfterRejectionHandlerTests()
    {
        _repoMock = new Mock<ITimeSheetRepository>();
        _uowMock = new Mock<IUnitOfWork>();
        _handler = new EditAfterRejectionHandler(_repoMock.Object, _uowMock.Object);
    }

    [Fact]
    public async Task Handle_ValidCommand_ShouldEditAndReturnTrue()
    {
        // Arrange
        ...
        ts.Submit();
        ts.Reject("Rejected");
        var command = new EditAfterRejectionCommand(tsId);
