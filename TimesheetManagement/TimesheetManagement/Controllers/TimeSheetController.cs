    ...
    public class TimeSheetController : Controller
    {
        ...
        public ActionResult Add(TimeSheetModel timesheetmodel)
        {
            try
            {
                ...
                objtimesheetmaster.UserID = Convert.ToInt32(HttpContext.Session.GetInt32("UserID"));
        ...
        private void SaveTimeSheetDetail(string DaysofWeek, int? Hours, DateTime? Period, int? ProjectID, int TimeSheetMasterID)
        {
            try
            {
                ...
                objtimesheetdetails.UserID = Convert.ToInt32(HttpContext.Session.GetInt32("UserID"));
        ...
        public JsonResult CheckIsDateAlreadyUsed(DateTime FromDate)
        {
            try
            {
                ...
                var data = _ITimeSheet.CheckIsDateAlreadyUsed(FromDate, Convert.ToInt32(HttpContext.Session.GetInt32("UserID")));
                return Json(data);
            }
            catch (Exception)
            {
        ...
        public JsonResult Delete(int TimeSheetMasterID)
        {
            try
            {
                ...
                var data = _ITimeSheet.DeleteTimesheetByTimeSheetMasterID(TimeSheetMasterID, Convert.ToInt32(HttpContext.Session.GetInt32("UserID")));
        ...
        private TimeSheetAuditTB InsertTimeSheetAudit(int TimeSheetMasterID, int Status)
        {
            try
            {
                ...
                objAuditTB.ApprovalUser = _IUsers.GetAdminIDbyUserID(Convert.ToInt32(HttpContext.Session.GetInt32("UserID")));
                objAuditTB.ProcessedDate = DateTime.Now;
                objAuditTB.UserID = Convert.ToInt32(HttpContext.Session.GetInt32("UserID"));
                return objAuditTB;
            }
            catch (Exception)
            {
