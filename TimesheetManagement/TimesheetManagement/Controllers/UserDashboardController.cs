...
namespace TimesheetManagement.Controllers
{
    public class UserDashboardController : Controller
    {
        ...
        {
            var timesheetResult = _ITimeSheet.GetTimeSheetsCountByUserID(Convert.ToString(HttpContext.Session.GetString("UserID")));
            ...
            var expenseResult = _IExpense.GetExpenseAuditCountByUserID(Convert.ToString(HttpContext.Session.GetString("UserID")));
