...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL16.DEVENV\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL16.DEVENV\MSSQL\DATA\"
...
GO
PRINT N'Creating Procedure [dbo].[GetCustomerDetails]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetEmployeeDetails]...';
...
AS
	...
	END
GO
PRINT N'Creating Procedure [DBO].[GetNorthwindEmployees]...';
...
GO
PRINT N'Creating Procedure [dbo].[Sp_Employee]...';
