CREATE DATABASE [DemoDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DemoDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.DEVENV\MSSQL\DATA\DemoDB.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DemoDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.DEVENV\MSSQL\DATA\DemoDB_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 WITH LEDGER = OFF
GO
...
GO
ALTER DATABASE [DemoDB] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
